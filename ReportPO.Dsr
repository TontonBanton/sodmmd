VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ReportPO 
   Bindings        =   "ReportPO.dsx":0000
   ...
   BeginProperty Section4 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "SUBMIT ORIGINAL COPY OF INVOICE UPON DELIVERY"
      EndProperty
      ItemType2       =   5
...
Private Sub DataReport_Initialize()
  ...
  ReportPO.Sections("Command7_Header").Controls("lblComp").Caption = FormSettings.txtComp.Text
  ReportPO.Sections("Command7_Header").Controls("lblLocation").Caption = FormSettings.txtLocation.Text
  ReportPO.Sections("Command7_Header").Controls("lblAdress").Caption = FormPO.txtPOSupAd.Text
  ReportPO.Sections("Command7_Header").Controls("lblRemark2").Caption = FormPO.txtPORemark.Text
  ReportPO.Sections("Section2").Controls("lblNumWords").Caption = FormPO.txtNumWords.Text
  ReportPO.Sections("PageFooter").Controls("lblRemark").Caption = FormPO.txtPOWork2.Text
  ReportPO.Sections("PageFooter").Controls("lblPrepared").Caption = FormSettings.txtPrepared.Text
  ReportPO.Sections("PageFooter").Controls("lblNoted").Caption = FormSettings.txtNoted.Text
  ReportPO.Sections("PageFooter").Controls("lblApproved").Caption = FormSettings.txtApproved.Text
End Sub
Private Sub DataReport_Terminate()
  FormPO.Show
  FormPO.cmdPrint.Enabled = False
  FormPO.cmdCancel.Enabled = False
  FormPO.cmdDelete.Enabled = False
  'FormPO.cmdExit.SetFocus
End Sub

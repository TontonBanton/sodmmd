VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ReportTransfer 
   Bindings        =   "ReportTransfer.dsx":0000
   Caption         =   "TRANSMITTAL"
   ClientHeight    =   10950
   ClientLeft      =   120
   ClientTop       =   450
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "SOUTH DAVAO DEVELOPMENT CO. INC."
      EndProperty
      ItemType2       =   3
   ...
   EndProperty
End
Attribute VB_Name = "ReportTransfer"
...
Private Sub DataReport_Initialize()
  ...
  If ReportTransfer.Visible = False Then ReportTransfer.Show
    ReportTransfer.Sections("ReportHeader").Controls("lblComp").Caption = FormSettings.txtComp.Text
    ReportTransfer.Sections("ReportHeader").Controls("lblLocation").Caption = FormSettings.txtLocation.Text
    ReportTransfer.Sections("TransHeader").Controls("lblArea").Caption = FormTransfer.TRArea
  'ReportTransfer.Sections("ReportHeader").Controls("lblNow").Caption = Format(Date, "mmm-dd-yyyy")
  'ReportTransfer.Sections("PageFooter").Controls("lblTotal").Caption = FormMRR.txtMRSTotal.Text
  'ReportTransfer.Sections("PageFooter").Controls("lblRemark").Caption = FormTransfer.PORemark
   ReportTransfer.Sections("PageFooter").Controls("lblPrepared").Caption = FormSettings.txtPrepared.Text
   ReportTransfer.Sections("PageFooter").Controls("lblAudited").Caption = FormSettings.txtAudited.Text
   ReportTransfer.Sections("PageFooter").Controls("lblNoted").Caption = FormSettings.txtNoted.Text
   ReportTransfer.Sections("PageFooter").Controls("lblApproved").Caption = FormSettings.txtApproved.Text
End Sub
Private Sub DataReport_Terminate()
  FormTransfer.Show
  FormTransfer.cmdPrint.Enabled = False
  FormTransfer.cmdCancel.Enabled = False
  'FormTransfer.cmdDelete.Enabled = False
  'FormTransfer.cmdExit.SetFocus
End Sub

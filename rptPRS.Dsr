VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} ReportPRS 
   Bindings        =   "rptPRS.dsx":0000
   Caption         =   "PRINT PRS"
   ClientHeight    =   10950
   ClientLeft      =   120
   ClientTop       =   345
   ClientWidth     =   12375
   Icon            =   "rptPRS.dsx":001F
   MaxButton       =   0   'False
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "P U R C H A S E    R E Q U I S I T I O N    S L I  P"
      EndProperty
      ItemType1       =   5
...
Private Sub DataReport_Initialize()
  ...
  ReportPRS.Sections("ReportHeader").Controls("lblLocation").Caption = FormSettings.txtLocation.Text
  ReportPRS.Sections("ReportHeader").Controls("lblComp").Caption = FormSettings.txtComp.Text
  ReportPRS.Sections("ReportHeader").Controls("lblNow").Caption = Format(Date, "mmm-dd-yyyy")
  ReportPRS.Sections("PageFooter").Controls("lblPrepared").Caption = FormSettings.txtPrepared.Text
  ReportPRS.Sections("PageFooter").Controls("lblNoted").Caption = FormSettings.txtNoted.Text
  ReportPRS.Sections("PageFooter").Controls("lblApproved").Caption = FormSettings.txtApproved.Text
End Sub
Private Sub DataReport_Terminate()
  FormPRS.Show
  FormPRS.cmdPrint.Enabled = False
  FormPRS.cmdCancel.Enabled = False
  FormPRS.cmdDelete.Enabled = False
  'FormPRS.cmdExit.SetFocus
End Sub
